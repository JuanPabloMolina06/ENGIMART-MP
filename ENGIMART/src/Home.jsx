...
function Home(){
    ...
    <div className="relative min-h-screen flex flex-col justify-center items-center">
      ...
      <div className="relative flex justify-center mt-10">
        <img src={"./logo-Home.png"} alt="Logo Engimart" className="w-[200px] h-auto" />

    </div>

  
    <div className="flex justify-around w-full mt-10">
        <button className="bg-white w-[300px] h-[350px] rounded-lg shadow-lg flex flex-col items-center p-6">
